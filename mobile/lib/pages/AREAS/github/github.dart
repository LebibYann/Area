...
const Color githublack = Color(0xFF7289DA);
const String service = "github";
const String Service = "Github";
  ...
  void handleCallback(BuildContext context, String redirectUri) async {
    HttpServer.bind('127.0.0.1', 8082).then((server) {
      server.listen((HttpRequest request) async {
        ...
        await postAuth2(authorizationCode, "http://localhost:8080/oauth2/$service", redirectUri, context);
      });
    });
  }
